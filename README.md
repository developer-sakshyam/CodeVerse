...
| Name | Role | Skills |
|------|------|--------|
| **Sakshyam Kharel** | Founder / Developer | HTML, CSS, App Vision |
| **Milan Tamang** | Front-End Engineer | JavaScript, UI/UX |
| **Raj Acharya** | Full-Stack Dev | Frontend + Backend |
| **Greshi Chamlagain** | Presentation Lead | Communication & Research |
...
| Technology | Purpose |
|-------------|----------|
| **HTML / CSS / JS** | Core Web Framework |
| **React + TailwindCSS** | Modern UI Design |
| **Python / FastAPI** | Backend & AI Integration |
| **SQLite / MongoDB** | Lightweight & Scalable Storage |
